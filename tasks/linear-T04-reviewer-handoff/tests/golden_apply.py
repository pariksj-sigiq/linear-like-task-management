#!/usr/bin/env python3
"""Apply the golden end-state for linear-T04 through the tool server."""
...
TASK_ID = 'linear-T04'
CALLS: list[tuple[str, dict[str, Any]]] = [('update_issue', {'identifier': 'LIN-099', 'assignee_username': 'sam.chen', 'status_name': 'In Progress'}), ('apply_issue_labels', {'identifier': 'LIN-099', 'label_names': ['Reviewer']}), ('add_comment', {'issue_identifier': 'LIN-099', 'body': 'Sam owns the reviewer follow-up.'})]
