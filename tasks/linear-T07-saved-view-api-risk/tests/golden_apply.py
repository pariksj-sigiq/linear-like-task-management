...
TASK_ID = 'linear-T07'
CALLS: list[tuple[str, dict[str, Any]]] = [('create_saved_view', {'owner_username': 'alex.rivera', 'name': 'Mine: High API Risk', 'scope': 'personal', 'filters': {'team_key': 'PLAT', 'assignee_username': 'alex.rivera', 'priorities': ['high', 'urgent'], 'label_names': ['API', 'Security'], 'exclude_status_names': ['Done', 'Canceled']}, 'display': {'mode': 'list', 'group_by': 'status'}})]
