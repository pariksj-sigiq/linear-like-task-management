#!/usr/bin/env python3
"""Apply the golden end-state for linear-T11 through the tool server."""
...
TASK_ID = 'linear-T11'
CALLS: list[tuple[str, dict[str, Any]]] = [('bulk_update_issues', {'identifiers': ['LIN-150', 'LIN-151', 'LIN-152'], 'priority': 'high', 'assignee_username': 'taylor.nguyen', 'cycle_id': 'cyc-platform-w18'})]
