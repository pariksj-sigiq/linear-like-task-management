#!/usr/bin/env python3
"""Apply the golden end-state for linear-T08 through the tool server."""
...
TASK_ID = 'linear-T08'
CALLS: list[tuple[str, dict[str, Any]]] = [('mark_inbox_read', {'notification_id': 'notif-alex-001'}), ('archive_inbox_notification', {'notification_id': 'notif-alex-001'}), ('mark_inbox_read', {'notification_id': 'notif-alex-002'}), ('archive_inbox_notification', {'notification_id': 'notif-alex-002'})]
