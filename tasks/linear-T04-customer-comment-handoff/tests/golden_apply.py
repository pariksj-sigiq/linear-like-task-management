...
TASK_ID = 'linear-T04'
CALLS: list[tuple[str, dict[str, Any]]] = [('update_issue', {'identifier': 'LIN-099', 'assignee_username': 'sam.chen', 'status_name': 'In Progress'}), ('apply_issue_labels', {'identifier': 'LIN-099', 'label_names': ['Customer']}), ('add_comment', {'issue_identifier': 'LIN-099', 'body': 'Sam owns the customer follow-up.'})]
